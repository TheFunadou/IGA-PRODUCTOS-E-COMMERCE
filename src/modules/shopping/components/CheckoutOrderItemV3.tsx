...
const CheckoutOrderItemV3 = ({ data }: Props) => {
    ...
    return (
        <div className="w-full rounded-2xl bg-base-100 border border-base-300 p-3 sm:p-4 md:p-5">
            <div className="flex gap-4 sm:gap-5">

                {/* ── Image ── */}
                <Link to={productUrl} className="shrink-0 group">
                    <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded-xl overflow-hidden border border-base-300 group-hover:border-primary/50 transition-colors duration-200 aspect-square relative">
                ...
                <div className="flex-1 min-w-0 flex flex-col gap-2">
                    ...
                    {/* Category + Tags */}
                    <div className="flex flex-wrap items-center gap-1.5 text-xs sm:text-sm text-base-content/50">
                        <Link
...
export default CheckoutOrderItemV3;
